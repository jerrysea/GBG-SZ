...
namespace PanGu.Framework
{
    ...
    public class Lexical:DFA<int, LexicalFunction>
    {
        ...
        private readonly static DFAState<int, LexicalFunction> s0 = AddState(new LexicalState(0)); //Start state;
        private readonly static DFAState<int, LexicalFunction> sother = AddState(new LexicalState(255, true, LexicalFunction.Other)); //Start state;
