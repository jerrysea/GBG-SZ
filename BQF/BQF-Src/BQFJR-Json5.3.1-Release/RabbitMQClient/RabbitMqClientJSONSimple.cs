...
namespace SCM.RabbitMQClient
{
    ...
    public class RabbitMqClientJSONSimple : IRabbitMqClient
    {
        ...
        public RabbitMqClientJSONSimple(string host, string vhost, string queue, int port, string user, string password, string encode, bool needdeclare = true, bool synchronizationFlag = false)
        {
            MQHost = host;
            MQVHost = vhost;
            MQPort = port;
