...
namespace Instinct.RabbitMQ.FraudCheckWinService.DAL
{
    ...
    public class InstinctFraudCheckThread
    {
        ...
        {
            ClsOnlineServiceCall.InstinctServiceOnline clsOnlineCall = new ClsOnlineServiceCall.InstinctServiceOnline(inputString.Trim(), LogMSG, ClsOnlineServiceCall.InstinctServiceOnline.TypeOfInstinctCall.LoadAndFraudCheck);
        ...
        public string InstinctFraudCheck_XMLString(string inputXMLString)
        {
            ...
            clsOnlineCall = new ClsOnlineServiceCall.InstinctServiceOnline(sInputString, LogMSG, ClsOnlineServiceCall.InstinctServiceOnline.TypeOfInstinctCall.LoadAndFraudCheck);
            ...
            return clsParse.GetOutputXMLString(clsOnlineCall.GetOutputStr, bOutputUser, bOutputRules, bOutputRulesDescription, bOutputDecisionReason, bOutputUserDefinedAlert, bOutputActionCountNumber, bOutputNatureOfFraud, bOutputDiary, clsSetINIValue.SiteWithSpecialFunctions, bOutputFraudAlertUserId,clsSetINIValue.IsRiskAssessmentMode);
        }
        /// <summary>
        /// 提交最终判定接口
        /// </summary>
        ...
        public string SubmitApplication_String(string inputString)
        {
            ...
            //**************************************************************************************************************************************************
            clsOnlineCall = new ClsOnlineServiceCall.InstinctServiceOnline(inputString, LogMSG,ClsOnlineServiceCall.InstinctServiceOnline.TypeOfInstinctCall.LoadAndFraudCheck);
